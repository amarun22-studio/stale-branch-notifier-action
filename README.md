...
This action scans all branches in your repository, identifies those with no recent commits, and notifies the branch authors via GitHub Issues. It includes:
...
- ✅ Perfect for keeping repositories clean
...
Instead of hardcoding values, use GitHub Repository Variables for better security and reusability:
...
- **[branch-hygiene-bot](https://github.com/amarun22-PS/branch-hygiene-bot)** - Full stale branch detection repository with advanced features and testing infrastructure
